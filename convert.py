...
# Sad day - imgur forced downscaling, google drive not compatible, and I'm not finding the Steam API
...
def package_pages(fronts, backs, page_count):
...
# Only useful if you have it uploaded somewhere, but this logic is sound.
...
def convert():
    ...
    package_pages(filtered_fronts, filtered_backs, deck_count)
